 ...
 */
public class MarkersTestStegoImage
{

    StegoImage img1, img2, img3;

    /**
     * Default constructor for test class TestStegoImage
     */
    public MarkersTestStegoImage()
    {
    }
     ...
     * Test images in the main submission directory above stu code directory
     */
    @Before
    public void setUp()
    {
        ...
        img3 = new StegoImage("ProjectImages/messages/image23.png");
    }
    ...
    /**
     * new markers test for decode methods
     */
    @Test
    public void testDecodeImage() {
        Color c1,c2;
        StegoImage secret = img3; //as encrypted
        secret.setToLowBit();  //get its low bit, which is the secret
        secret.setBlackWhite(); //scale up
        c1 = new Color(secret.getImage().getRGB(150,151)); 
        //showPix(c1);
        assertEquals(255,c1.getRed());
        assertEquals(255,c1.getGreen());
        assertEquals(255,c1.getBlue());
        c2 = new Color(secret.getImage().getRGB(150,200));
        //showPix(c2);
